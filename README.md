...
ชุดข้อมูลรวมทั้งหมด 114,403 รายการ แบ่งเป็น 102,962 สำหรับฝึกสอน / 5,674 สำหรับตรวจสอบ / 5,679 สำหรับทดสอบ (ส่วนต่าง 88 รายการมาจากการคัดข้อมูลซ้ำข้ามชุด train/valid/test) ข้อมูลถูกรวบรวมมาจาก 22 แหล่ง ครอบคลุมถึง ข้อมูลข่าวกรองภัยคุกคาม (threat intel), ฐานข้อมูลช่องโหว่, ขั้นตอนการปฏิบัติงานของ Red Team, การแลกเปลี่ยนความรู้/บทสนทนาด้านความปลอดภัย (security discourse), และตัวอย่างสถานการณ์ความไม่แน่นอนที่สังเคราะห์ขึ้น (synthetic uncertainty).
...
สัดส่วนของชุดข้อมูล: 81.1% เป็นแหล่งข้อมูลจากมนุษย์, 18.2% เป็นข้อมูลที่สร้างขึ้นโดย AI (ชุดข้อมูลจาก Hugging Face — Fenrir v2.0 + Cyber v1), และ 0.7% เป็นตัวอย่างสถานการณ์ความไม่แน่นอนที่สร้างขึ้นด้วย Claude Opus 4.7
